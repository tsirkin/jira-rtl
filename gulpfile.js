// Cpyed from excellent metamask plugin
...
gulp.task('lint', function () {
  ...
  return gulp.src(['app/**/*.js', '!node_modules/**', '!dist/firefox/**', '!docs/**', '!app/scripts/chromereload.js', '!mascara/test/jquery-3.1.0.min.js'])
